  ...
  */
  ...
  val randIntFeeder = new Feeder[String] {
	...
	val scn = scenario("GeneTextSearchBodies")
      ...
      .check(regex("${feed.expectedHit}").exists)
		)
		.exec(
            http("showResultSize")
